...
export const seedServices = [
  {
    ...
    sortOrder: 1,
    title: 'SPMB',
    summary: 'Pendaftaran murid baru untuk unit pendidikan YTS.',
    category: 'Pendidikan',
...
export const seedFaqs = [
  {
    ...
    summary: 'Melalui layanan SPMB milik unit pendidikan terkait.',
    answer:
      'Pendaftaran dilakukan melalui layanan SPMB milik unit pendidikan terkait. Buka halaman layanan SPMB untuk melihat persyaratan, alur, dan tautan resmi ke sistem pendaftaran. Detail persyaratan mengikuti pengumuman resmi unit.',
    categorySlug: 'pendidikan',
    ownerUnitSlug: 'ts-lab-school',
    keywords: ['spmb', 'pendaftaran', 'sekolah', 'preschool', 'spmb'],
    relatedServiceSlugs: ['spmb'],
...
export const seedEvents = [
  ...
  {
    code: `${SEED_CODE_PREFIX}EVENT-SOSIALISASI-SPMB`,
    slug: 'sosialisasi-spmb',
    sortOrder: 3,
    title: 'Sosialisasi SPMB',
    summary: 'Penjelasan alur dan persyaratan pendaftaran untuk orang tua calon murid.',
